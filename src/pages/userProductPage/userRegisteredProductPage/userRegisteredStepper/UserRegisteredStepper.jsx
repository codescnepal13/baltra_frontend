...
const getMessage = (statusName) => {
  ...
  // Fallback: catch any future "part consumed" variant not explicitly mapped
  ...
  // Fallback: catch any "part pending" / "parts pending" variant
  ...
  // Fallback: catch any "in transit" variant
...
const UserRegisteredStepper = ({ singleAddedProduct }) => {
  ...
  const topLevelStatus = singleAddedProduct?.status ?? "";
            ...
            >
              ...
              <div className="pt-2 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <span
                    className={`text-sm font-medium ${isPending ? "text-gray-400" : "text-gray-800"}`}
                  >
                    {rawLabel || "—"}
                  </span>
                  {isDone && (
