...
const SelectField = ({
  ...
  <div className="flex flex-col gap-1">
    ...
    {disabled && (
      <span className="text-[10.5px] text-gray-400 tracking-[0.02em]">
...
const SingleSubCategory = () => {
  ...
  useEffect(() => {
    if (subCategoryProduct) {
      ...
      setImagePreview(subCategoryProduct?.image || "");
    }
  ...
  useEffect(() => {
    if (id) dispatch(subCategoryById(id));
  }, [dispatch, id]);
  ...
  return (
    <div className="font-inter px-4 py-4 max-w-screen-2xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-[12px] text-gray-400 tracking-[0.01em] mt-0.5">
            Update the sub-category name or image. Parent category is read-only.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-start gap-2.5 bg-amber-50 border border-amber-100 rounded-lg px-4 py-3 mb-6">
        ...
        <p className="text-[12px] text-amber-700 tracking-[0.01em] leading-[1.6]">
          You are editing an existing sub-category. The{" "}
          <strong>parent category</strong> is locked and cannot be changed.
          Update the <strong>name</strong> or <strong>image</strong> and save.
        </p>
      </div>
