...
const ResetOTPVerify = () => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(verifyResetOTP({ OTPData, enqueueSnackbar, navigate }));
  };
  ...
  return (
    <>
      <MetaData title="Baltra resetVerifyOTP" />
          ...
          >
            ...
            <div className="mb-8 px-2 w-full text-center">
              ...
              <p className="text-sm text-zinc-900 font-gothamNarrow tracking-wide mb-4">
                Don't worry! Just enter 6 digit OTP that we'll send in your
                Mobile.
              </p>
            </div>
