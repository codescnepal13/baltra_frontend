...
import { HiSearch, HiOutlineUser, HiOutlineUserCircle } from "react-icons/hi";
      ...
      <div className="font-gothamNarrow text-[#000000] relative w-full h-16 flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24">
        ...
        <div className="hidden md:flex space-x-4 lg:space-x-6 ml-4 lg:ml-8 font-gothamNarrow">
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "text-red-600 underline font-medium"
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="relative text-gray-600 hover:text-gray-700 flex flex-col items-center">
            {isAuthenticated && customer ? (
              <NavLink to="/baltra-trackingProducts">
                <RiCustomerService2Line className="flex flex-col items-center" />
              </NavLink>
            ) : (
              <NavLink to="/baltra-catalog" className="w-6 h-6">
                <FaBookOpen className="w-6 h-6 sm:w-8 sm:h-8" />
              </NavLink>
            )}
          </div>
          ...
          <NavLink
            to="/baltra-allProducts"
            className="relative text-gray-600 hover:text-gray-700 flex flex-col items-center"
          >
            <AiOutlineProduct className="w-6 h-6 sm:w-8 sm:h-8" />
          </NavLink>
          ...
          {isAuthenticated && customer ? (
            ...
            >
              <button className="focus:outline-none">
                {customer?.image_url ? (
                  ...
                  <HiOutlineUserCircle
                    size={28}
                    className="w-6 h-6 sm:w-8 sm:h-8 text-gray-600 hover:text-gray-700"
                  />
                )}
              </button>
            </NavLink>
            ...
            <NavLink
              ...
              className="text-gray-600 hover:text-gray-700 flex flex-col items-center"
            >
              <MdPersonOutline className="w-6 h-6 sm:w-8 sm:h-8" />
            </NavLink>
          )}
        </div>
      </nav> */}
