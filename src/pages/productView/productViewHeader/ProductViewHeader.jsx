...
const ProductViewHeader = ({ isAuthenticated, customer }) => {
      ...
      <div className="font-gothamNarrow text-[#000000] relative w-full h-16 flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24">
        ...
        <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
          <div className="w-32 sm:w-40 lg:w-56 h-8 sm:h-10 p-2 bg-[rgba(255,255,255,0.09)] rounded-[35px] border border-[#000000] flex justify-start items-center relative">
            <HiSearch className="absolute left-2 text-black w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
            <input
              type="text"
              placeholder="Search"
              value={product_name}
              ...
              className="bg-transparent border-none text-black text-xs sm:text-sm lg:text-base font-gothamNarrow font-normal placeholder-[#928686] focus:outline-none pl-8 sm:pl-10"
            />
          </div>
