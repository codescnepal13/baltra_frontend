...
const BaltraApplianceCareHeader = () => {
  ...
  return (
    <>
      <div className="font-gothamNarrow relative w-full h-8 backdrop-blur-md flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 text-white">
        {/* Logo */}
